...
const ResendPassport = () => {
    ...
    const {INITIAL_FORM_STATE, FORM_VALIDATION_RESENT} = FormNew({
        ticket: '',
    })
    ...
    const onSubmit = async ({
      ...
      await api.patch(`admins/passports/${ticket}/resend`, ticket, {headers})
            ...
            <Container maxWidth="xs" className='cardGradiente' sx={{paddingTop: '60px', textAlign: 'center'}}>
                <Grid container spacing={1}>
                    ...
                    <Formik
                      ...
                      validationSchema={FORM_VALIDATION_RESENT}
                      onSubmit={onSubmit}
                    >
                      {()=>(
                          <Form>
