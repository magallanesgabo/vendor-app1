    ...
    <ThemeProvider theme={theme}>
        <Grid item xs={12}>
            <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex:30 }} elevation={3} >
                ...
                >
                    <CustomBottomNavigationAction component={Link} to="/home" label="Home" icon={<HomeIcon />} />
                    <CustomBottomNavigationAction component={Link} to="/vendor/scan-code" label="Scan QR" icon={<QrCodeScannerIcon />} />
                    <CustomBottomNavigationAction component={Link} to="/vendor/vendor-report" label="Vendor Rp" icon={<AssignmentIcon />} />
